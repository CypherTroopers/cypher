...
var (
	...
	// AllcolossusXProtocolChanges contains every protocol change (EIPs) introduced
	// and accepted by the Ethereum core developers into the colossusX consensus.
	//
...
func (c *colossusXConfig) String() string {
	return "colossusX"
}
